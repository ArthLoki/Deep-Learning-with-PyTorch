...
class Chapter4:
    ...
    def __init__(self):
        ...
        self.base_path_image = f'{self.base_path}/dlwpt-code/data'
        pass
    ...
    def working_with_images(self):
        ...
        # img_arr = imageio.imread(f'{self.base_path_image}/p1ch4/image-dog/bobby.jpg')
        # print(img_arr.shape)
        ...
        data_dir = f'{self.base_path_image}/p1ch4/image-cats/'
    ...
    def volumetric_data_3d_image(self):
        ...
        dir_path = f'{self.base_path_image}/p1ch4/volumetric-dicom/2-LUNG 3.0 B70f-04083/'
